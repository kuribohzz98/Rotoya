...
export class SportGroundImage extends BaseEntity<SportGroundImageAttribute>
  implements SportGroundImageAttribute {
  @PrimaryGeneratedColumn()
  id: number;
  ...
  @ManyToOne(
    type => SportGround,
    sportGround => sportGround.sportGroundImages,
  )
