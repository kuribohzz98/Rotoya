...
@Entity({ name: 'booking' })
export class Booking extends BaseEntity<BookingAttribute>
  ...
  @ManyToOne(
    ...
    sportGroundTimeSlot => sportGroundTimeSlot.bookings,
  )
  ...
  @OneToMany(
    ...
    sportCenterEquipmentBooking => sportCenterEquipmentBooking.booking,
  )
  sportCenterEquipmentBookings: SportCenterEquipmentBooking[];

  @ManyToMany(
    type => SportCenterEquipment,
    sportCenterEquipment => sportCenterEquipment.bookings,
  )
  @JoinTable({
