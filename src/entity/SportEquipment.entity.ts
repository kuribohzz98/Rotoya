...
export class SportEquipment extends BaseEntity<SportEquipmentAttribute>
  ...
  @ManyToOne(
    type => Sport,
    sport => sport.sportEquipments,
  )
  sport: Sport;

  @ManyToMany(
    type => SportCenter,
    sportCenter => sportCenter.sportEquipments,
  )
  sportCenters: SportCenter[];

  @OneToMany(
    type => SportCenterEquipment,
    sportCenterEquipment => sportCenterEquipment.sportEquipment,
  )
