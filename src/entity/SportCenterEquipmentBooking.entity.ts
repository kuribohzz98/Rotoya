...
export class SportCenterEquipmentBooking
  extends BaseEntity<SportCenterEquipmentBookingAttribute>
  implements SportCenterEquipmentBookingAttribute {
  @PrimaryGeneratedColumn()
  id: number;
  ...
  @ManyToOne(
    ...
    sportCenterEquipment => sportCenterEquipment.sportCenterEquipmentBookings,
  )
  ...
  @ManyToOne(
    type => Booking,
    booking => booking.sportCenterEquipmentBookings,
  )
