...
@Entity({ name: 'sport' })
export class Sport extends BaseEntity<SportAttribute>
  implements SportAttribute {
  @PrimaryGeneratedColumn()
  id: number;
  ...
  @OneToOne(
    type => SportGround,
    sportGround => sportGround.sport,
  )
  sportGround: SportGround;

  @ManyToMany(
    type => SportCenter,
    sportCenter => sportCenter.sports,
  )
  sportCenters: SportCenter[];

  @OneToMany(
    type => SportCenterSport,
    sportCenterSport => sportCenterSport.sport,
  )
  sportCenterSports: SportCenterSport[];

  @OneToMany(
    type => SportEquipment,
    sportEquipment => sportEquipment.sport,
  )
